<div class="container mt-5">
        ...
        <div class="row justify-content-center mt-5">
            <div class="col-md-10 text-center">
                ...
                <div class="ul-widget__body card rounded-0 wow animate__fadeInUp" data-wow-duration="3s" id="ui-widget-body" >
                    ...
                    <div class="tab-pane" id="ul-widget2-tab4-content">
                        <div class="ul-widget1">
                            <div class="ul-widget2__item">
                                <div class="">
                                    <div class="card-body d-flex align-items-center">
    ...
    <!--   LEARNING HUB BLOCKS STARTS-->
    <div class="row text-center mt-5 justify-content-center p-2">
        <div class="col-lg-8 col-md-10">
            <h3 class="mb-4 text-center text-28 f-26 wow animate__fadeInUp" data-wow-duration="2s">Learn best practices from<br/> Human Resource experts</h3>
